...
// 获取账户签名
const getAutographValue = async (address: string) => web3.eth.personal.sign(web3.utils.utf8ToHex(`Welcome to Element! Click "Sign" to sign in. No password needed!`), address)
    .then((res: string) => {
        return res
    }).catch((e: any) => {
